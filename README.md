...
- 🚪 **[Logout Button](https://github.com/Soren-Starck/gnome-shell-extension-logout-button)** - Logout button for GNOME panel, open source - 1,200+ users
...
- 🎨 **[Mockup Stage](https://mockupstage.com)** - AI-powered SaaS that generates photorealistic website mockups in seconds, powered by Nano Banana Pro (Gemini)
- 🧩 **[S2-UI](https://github.com/Soren-Starck/S2-UI)** - React + Tailwind CSS component library with a custom CLI, global theming, and Framer Motion animations
